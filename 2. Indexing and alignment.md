...
cd /fs/ess/scratch/PAS2303/Jonathan/Gene_Expression/Rsubread/Sooty_Blotch
...
setwd("/fs/ess/scratch/PAS2303/Jonathan/Gene_Expression/Rsubread/Sooty_Blotch")

# Build Index
library(Rsubread)
buildindex(basename="P_fructicola_Index",reference="/fs/ess/scratch/PAS2303/Jonathan/Gene_Expression/Reference/Sooty_Blotch/P_fructicola.fasta")
...
```
# First we will prepare a R script for this alignment and counting of features, look at the parttern and structure carefully:
cd /fs/ess/scratch/PAS2303/Jonathan/Gene_Expression/Rsubread/Sooty_Blotch
